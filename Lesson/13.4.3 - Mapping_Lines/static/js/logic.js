...
// ADDING LINES
// Coordinates for each point (start and end) to be used in the line.
...
// Using .polyline pass the line coordinates and make the line yellow and add it to the map
L.polyline(line, {
    color: "yellow"
  }).addTo(map);
