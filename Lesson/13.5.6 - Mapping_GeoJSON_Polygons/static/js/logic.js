...
// MAPPING POINTS
// Grabbing our GeoJSON data which stores the co-ordinates of our airports 
...
// MAPPING LINES
// create a variable to obtain the Geojson data from our GitHub repository 
// this file stores the coordinates for start/ending point for flight lines 
let torontoData = "https://raw.githubusercontent.com/BBBrian1124/Mapping_Earthquakes/main/Lesson/torontoRoutes.json";
...
// Grabbing our GeoJSON torontoData and add it to the map 
d3.json(torontoData).then(function(data) {
  console.log(data);
// Creating a GeoJSON layer with the retrieved data.
L.geoJson(data, { 
  style: lineStyle,
  // use onEachFeature to create the markers and popups and add to map 
  onEachFeature: function (feature, layer) {
...
// MAPPING POLYGONS
// https://leafletjs.com/reference-1.6.0.html#path-color for styling options
// Create a style for the lines.
let polyStyle = {
  // set the colour of the lines
  color: "blue",
  // set the fill colour of the polygons
  fillColor: "yellow",
  // set the weight of the lines
  weight: 1
}
// Accessing the Toronto neighborhoods GeoJSON URL
// this file contains the coordinates in a polygon format which creates a board for neighbourhoods 
let torontoHoods = "https://raw.githubusercontent.com/BBBrian1124/Mapping_Earthquakes/main/Lesson/torontoNeighborhoods.json";
// we can now see that this adds boarders around neighbourhoods in Toronto  
// use d3.json to obtain data from GitHub
d3.json(torontoHoods).then(function(data){
  console.log(data);
  L.geoJson(data, {
    // pass the style to the data
    style: polyStyle,
    // and use onEachFeature to add popups
    onEachFeature: function (feature, layer) {
